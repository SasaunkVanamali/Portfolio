...
export const experiences = [
  {
    ...
    desc: " Developing the Augvents app, utilizing React for a dynamic front-end and MongoDB for efficient data management.Designing and implementing responsive UI components and configuring the database to handle complex queries and storage. ",
    skills: [
      "ReactJS",
      "NodeJs",
      "MongoDB",
